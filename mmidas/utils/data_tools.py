...
def load_data_BN(file='/home/shuonan.chen/scratch_shuonan/code/LC-NE-MixRep/data/snRNA_BN_norm1.h5ad',
                 cpm_scl = 1e+6):
...
def load_data_raw(file='/home/shuonan.chen/scratch_shuonan/LC_scRNAseq/conversion_files/snRNAseq_LCNE_BN_d4_1-5k.h5ad',
                 cpm_scl = 1e+6):
    print(f'defined CPM scalar is {cpm_scl}')
    data = dict()     
    adata = sc.read_h5ad(file)
